...
import br.com.luizgabriel.farmaorder.notification.NotificationRepository;
...
@Sql(value = "/sql/order/delete-orders.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
