...
public class DistributorService {
    ...
    public Page<DistributorGetResponse> findAll(Pageable pageable) {
        return repository.findAll(pageable)
                .map(mapper::toDistributorGetResponse);
    }
    ...
    public DistributorGetResponse save(DistributorPostRequest request) {
        ...
        var saved = repository.save(distributor);

        return mapper.toDistributorGetResponse(saved);
    }
    ...
    public DistributorGetResponse update(UUID id, DistributorPostRequest request) {
        ...
        var updated = repository.save(distributor);

        return mapper.toDistributorGetResponse(updated);
    }
